...
The workflow now leans on deterministic lint before judge review. Cheap structure and surface-form issues are linted first, judge review is reserved for semantic faithfulness and doctrinal ambiguity, and review findings are routed into explicit accept, repair, or escalate decisions with persisted routing artifacts.
